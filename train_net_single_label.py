...
def get_data(train_data_dir, train_ann_file, val_data_dir, val_ann_file, height, width, batch_size, workers, label_mode):
    ...
    train_loader = DataLoader(
        VideoTrainPreprocessor(train_data_dir, train_labels, transform=train_transformer, 
        num_frames = args.n_frames, label_mode = label_mode),
...
if __name__ == '__main__':
    ...
    parser.add_argument('--label_mode', type = str, default = 'single-class',
